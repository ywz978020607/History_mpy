...
#################################################################
    ...
    b'AT+MQTTCFG="183.230.40.39",6002,"524485249",1800,"234533","2kJV69exxxxxxxxxxxx",1' #MQTT配置
...
#onenet mqtt 旧版
# 524485249  产品ID：234533  api='2kJV6xxxxxxxxxxxx'
################################################################
i=0
u.write(CMD[i] + b'\r\n')
u.read()
...
#配置
u.write(b'AT+MQTTCFG="183.230.40.39",6002,"524485249",1800,"234533","2kJxxxxxxxxxxxxxx",1'+b'\r\n')
u.read()
